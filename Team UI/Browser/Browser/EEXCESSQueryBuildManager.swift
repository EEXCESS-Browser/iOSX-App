...
class EEXCESSQueryBuildManager:AbstractQueryBuildManager{
    ...
    override func delegate(sechs:[String:Sech],preferences:[String:String])->NSData?{
        let json = JSONObject()
        var queryID = ""
